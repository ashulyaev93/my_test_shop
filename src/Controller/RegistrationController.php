...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, MailerInterface $oMailer, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        if ($this->getUser()) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $email = (new TemplatedEmail())
                    ->from(new Address('sav30101993@gmail.com', 'Alex'))
                    ->to($user->getEmail())
